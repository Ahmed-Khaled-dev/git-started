...
int main()
{
    ...
    // Fonts
    Font buttons_font;
    if (!buttons_font.loadFromFile("resources/fonts/Lato-MediumItalic.ttf")) {
    ...
    Text level1_text("Tragic Failure: The Cost of Poor Organization (git init)", buttons_font, 25);
    Text level2_text("Stage and Shine: Unleash Your Staging Prowess! (git add)", buttons_font, 25);
    Text level3_text("Committing to Success: Crafting Meaningful Commits (git commit)", buttons_font, 23);
    Text level4_text("TimeWarper: Navigating the Timeline (git checkout)", buttons_font, 25);
    Text level5_text("Branching Out: Conquer the Code Chaos! (git branch)", buttons_font, 25);
