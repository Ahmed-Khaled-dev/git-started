...
//structs
struct dialogueBox_declration //for dialogue box
{
    Font font;
    Texture texture; 
    Sprite sprite;
...
struct dialogueText_declration  //for dialogue text
{
    String font_type = "resources/fonts/Roboto-Black.ttf";
    Color text_color = Color::Blue;
    double text_size = 35;
    double text_speed = 0.09f;
    String dialogue_script = "This is our game\ngit-started\nwelcome boo!";
} dialogue_properties;

//functions definition 
void drawDialogue(RenderWindow& window, dialogueBox_declration& dialogue_box,RectangleShape& dialogueBox);
...
int main()
{
    ...
    while (window.isOpen())
    {
        ...
        drawDialogue(window,dialogue_box,dialogueBox);
...
void drawDialogue(RenderWindow& window,dialogueBox_declration& dialogue_box,RectangleShape& dialogueBox) 
{
    ...
    //title
    dialogue_box.dialogueTitle.setString(dialogue_box.title);
...
void printDialogueText(Time& dialogue_text_time, Text& dialogue_text_text, Clock& clock, Font& dialogue_text_font)
{
        ...
        dialogue_text_text.setPosition(850, 850);
